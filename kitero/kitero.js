...
function hideBasedOnCheckbox(checkbox){
     ...
     * @type {HTMLDivElement}
     */
    const parente = checkbox.parentElement
    ...
    if (checked)
    {
        makeVisibleBasedOnId(parente,"ferfi")
        makeInvisibleBasedOnid(parente, "no")
    }else
    {
        makeVisibleBasedOnId(parente,"no")
        makeInvisibleBasedOnid(parente, "ferfi")
    }
